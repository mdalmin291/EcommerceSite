                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control updateTable prevDate" id="from_date"
                                            name="from_date" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-lg-4">
                                    <div wire:ignore class="form-group">
                                        <label for="basicpill-firstname-input">Select Shop</label>
...
<script>
    $(document).ready(function(){
		...
		$('#profit_loss_report_table').DataTable({
			...
			serverSide: true,
			ajax: {
				url: "{{ route('report.profit-loss-report-data') }}",
				type: 'GET',
				cache: false,
                data : function ( d ) {
			...
			{ title: 'Quantity', data: 'total_out', name: 'total_out' },
			{ title: 'Avg Cost', data: 'avg_price', name: 'avg_price' },
			{ title: 'Profit/Loss', data: 'profit_loss', class: "profit_loss", name: 'profit_loss' },
			],
			...
			footerCallback: function(row, data, start, end, display) {
				var api = this.api();
				$.each(['payable_amount','profit_loss'], function( index, value ) {
