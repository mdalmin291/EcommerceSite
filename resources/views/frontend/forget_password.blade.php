...
<div class="wrapper-content">
	<div class="container">
        <div class="row">
				<form id="otpUpdate" class="col-sm-16" method="POST" action="{{ route('forget_password.update') }}">
						@csrf
						<div class="row">
                            <div class="offset-md-11 col-md-11">
                                    <h3 class="mt-2 text-center">Forget Passsword</h3>
                                <hr class="my-2">
...
<script>
    ...
    window.location = "{{route('forget_password.change')}}";
});
