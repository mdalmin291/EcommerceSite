                                    ...
                                    <table class="table table-centered mb-0 table-nowrap table-responsive-stack" id="tableOne">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($deliveredOrder->Contact)
                                                    {{$deliveredOrder->Contact->first_name}}
                                                    @endif
                                                </td>
                                                <td>
                                                    @if($deliveredOrder->Contact)
                                                    {{$deliveredOrder->Contact->shipping_address}}
                                                    @endif
                                                </td>
                                                <td>
                                                    {{date('d F Y', strtotime($deliveredOrder->order_date))}}<br>
                                                    {{date('h:i A', strtotime($deliveredOrder->order_date))}}
                                                </td>
                                                <td>
                                                                ...
                                                                {{-- @can('edit all_order') --}}
                                                                    @if ($deliveredOrder->status == 'delivered')
                                                                        <select class="form-control"
                                                                            ...
                                                                            <option value="returned {{ $deliveredOrder->id }}">
                                                                                Returned</option>
                                                                        </select>
                                                                    @endif
                                                                {{-- @endcan --}}
