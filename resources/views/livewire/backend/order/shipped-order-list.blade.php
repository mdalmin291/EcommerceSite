                                    ...
                                    <table class="table table-centered mb-0 table-nowrap table-responsive-stack"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($shippedOrder->Contact)
                                                    {{$shippedOrder->Contact->shipping_address}}
                                                    @endif
                                                </td>
                                                <td>
                                                    {{date('d F Y', strtotime($shippedOrder->order_date))}}<br>
                                                    {{date('h:i A', strtotime($shippedOrder->order_date))}}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <center>
                                                        <a class="btn btn-primary btn-sm mb-1"
                                                            href="{{ route('order.order-edit',['id'=>$shippedOrder->id]) }}"><i
