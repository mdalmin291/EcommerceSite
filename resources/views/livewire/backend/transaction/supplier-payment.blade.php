                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <a href="{{route('transaction.supplier-payment-report')}}"><button type="button"
                        ...
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info text-primary p-1"><i
                                                class="bx bx-printer font-size-18"
                                                wire:click="moneyReceiptModal({{ $payment->id }})"></i></button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="moneyReceipt1">
                    <div class="row">
                        <div class="col-3">
                            <img src="@if ($companyInfo){{ asset('storage/photo/' . $companyInfo->profile_photo) }} @endif"
                            ...
                            <span>
                                <span class="font-weight-bold">
                                    Invoice No: @if (isset($Receipt->PurchaseInvoice)) {{ $Receipt->PurchaseInvoice->id }}
                                    @endif
                                </span>
                            </span>
                            <br />
                            ...
                            <span>
                                <span class="font-weight-bold">
                                    Payment Method: @if (isset($Receipt->PaymentMethod)) {{ $Receipt->PaymentMethod->name }}
                                    @endif
                                </span>
                            </span>
                        </div>
                        ...
                        <div class="col-5 profile">
                            <h5>Company Name: @if (isset($companyInfo)) {{ $companyInfo->business_name }} @endif</h5>
                        ...
                        <div class="col-12">
                            <table style="width: 50%" class="amount small">
                                ...
                                <tr style="border: 1px solid black;">
                                    ...
                                    <th style="border: 1px solid black;">
                                        @if (isset($Receipt->PurchaseInvoice->payable_amount))
                                           {{ $Receipt->PurchaseInvoice->payable_amount }}
                                        @endif
                                    </th>
                                </tr>
                                <tr style="border: 1px solid black;">
                                    ...
                                    <th style="border: 1px solid black;">
                                        @if (isset($Receipt))
                                        {{ $Receipt->PurchaseInvoice->payable_amount - $Receipt->total_amount}}
                                        @endif
                                    </th>
                                </tr>
                            </table>
                        ...
                        {{-- <div class="col-4">
                            <table class="mt-2" style="border-collapse: collapse;border: 1px solid black;">
                                <tbody>
                                    <tr style="border: 1px solid black;">
                                    ...
                                    <tr style="border: 1px solid black;">
                                        ...
                                        <td style="border: 1px solid black;">Cheque</td>
                                    </tr>
                                    <tr style="border: 1px solid black;">
                                        <td style="border: 1px solid black;">
                                            <center>
                                        ...
                                        <td style="border: 1px solid black;">Money Order</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div> --}}
