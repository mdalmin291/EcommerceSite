            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div wire:ignore class="table-responsive">
                        <table class="display table table-striped table-bordered" id="PaymentTable"
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 @if($transaction)
                 <div>
                     <x-slot name="title">PAYMENT RECEIPT</x-slot>
                     <x-slot name="header">PAYMENT RECEIPT</x-slot>
