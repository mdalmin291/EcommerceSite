...
<div>
                        ...
                        <div class="col-sm-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                    <h4>Chart Of Group</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" wire:click="ChartOfGroupModal"><i class="mdi mdi-plus mr-1"></i>Chart of Group Info</button>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="ChartOfGroupTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;"></table>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div wire:ignore.self class="modal fade" id="ChartOfGroupModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Chart Of Group</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            var datatable = $('#ChartOfGroupTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('data.chart_Of_Group_table')}}",
                columns: [
                    {
                        title: 'SL',
                        data: 'id'
