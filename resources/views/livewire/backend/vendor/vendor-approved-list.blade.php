            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="VendorApprovedTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    function callCancel(id) {
        ...
        $(document).ready(function () {
            var datatable = $('#VendorApprovedTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('data.vendor_approved_table')}}",
                columns: [
                    {
                        title: 'SL',
                        data: 'id'
