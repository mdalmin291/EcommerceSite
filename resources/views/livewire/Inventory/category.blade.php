...
<div>
                      ...
                      <div class="col-sm-8">
                          <div class="text-sm-right">
                              <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"
                                      wire:click="CategoryModel"><i class="mdi mdi-plus mr-1"></i> New Category</button>
                          </div>
                      </div>
                  </div>
    ...
    <div wire:ignore.self class="modal fade" id="CategoryModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
