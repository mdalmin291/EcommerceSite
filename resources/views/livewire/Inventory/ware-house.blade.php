...
<div>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"
                                        wire:click="WarhouseModel"><i class="mdi mdi-plus mr-1"></i>Ware House Details</button>
                            </div>
                        </div>
                    </div>
    ...
    <div wire:ignore.self class="modal fade" id="WarhouseModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
